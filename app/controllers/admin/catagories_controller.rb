class Admin::CatagoriesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_catagories_path, status: :see_other, notice: "Catagory was successfully destroyed." }
  ...
  private
    ...
    def set_admin_catagory
      @admin_catagory = Admin::Catagory.find(params.expect(:id))
    end
